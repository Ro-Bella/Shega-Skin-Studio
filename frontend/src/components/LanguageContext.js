...
const translations = {
  am: {
    ...
    // Admin Registration
    addNewAdminAction: 'አዲስ አስተዳዳሪ ጨምር',
    adminRegistrationTitle: 'አዲስ አስተዳዳሪ ይመዝግቡ',
    newAdminEmailLabel: 'የአዲስ አስተዳዳሪ ኢሜይል',
    newAdminPasswordLabel: 'የይለፍ ቃል',
    registerButton: 'አስተዳዳሪውን ይመዝግቡ',
    registrationSuccessMessage: '✅ አዲስ አስተዳዳሪ በተሳካ ሁኔታ ተመዝግቧል።',
    registrationErrorMessage: '❌ አዲስ አስተዳዳሪ ሲመዘገብ ስህተት ተፈጥሯል:',
    // Reset Password
