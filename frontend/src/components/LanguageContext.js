...
export const LanguageProvider = ({ children }) => {
  ...
  const translations = {
    en: {
      ...
      selectServicePlaceholder: 'Signature Facial',
      ...
      adminLoginSuccess: 'Logged in successfully!', // Existing, but good to confirm
      superAdminAuthSuccess: 'Super admin authenticated successfully!', // Added
      serverError: 'Server error. Please try again later.', // Added
